...
Milestone 9 is complete only when the repository can explain not just that nodes launch, but that the launched nodes are a sensible fit for the workload mix.
