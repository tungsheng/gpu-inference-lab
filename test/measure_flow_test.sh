...
event:start_time" "measure flow should begin with cleanup, namespace setup, and start timestamp recording"
...
event:first_nodeclaim_seen" "cold-start flow should apply the inference manifest and record early milestones"
